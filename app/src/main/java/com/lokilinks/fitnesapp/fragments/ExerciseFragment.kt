...
import com.lokilinks.fitnesapp.databinding.ExerciseBinding
import com.lokilinks.fitnesapp.utils.FragmentManager
import com.lokilinks.fitnesapp.utils.MainViewModel
import com.lokilinks.fitnesapp.utils.TimeUtils
...
class ExerciseFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.bNext.setOnClickListener { nextExercise()}
    }
    ...
    private fun showNextExercise() = with(binding){
        if (exerciseCounter < exList?.size!!){
            ...
            imNext.setImageDrawable(GifDrawable(root.context.assets, "dance_hot_girl.gif"))
